              ...
              <CardContent className="space-y-6">
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  <div className="space-y-3">
                    <img src="/workflow-engine-holographic.png?v=20251022" alt="Workflow Orchestration Engine" className="rounded-lg border border-border/50 hover:scale-105 transition-transform duration-300" />
                    <div>
